...
export const MixOptimization = () => {
  ...
  const handleOptimize = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        ...
        { target_strength: parseFloat(targetStrength), material_costs: costs },
  ...
  const mixChartData = result
    ? Object.entries(result.optimized_mix).map(([key, value]) => ({
      ...
      <div className="border border-border p-6">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="target_strength" className="text-xs uppercase tracking-[0.2em] font-bold">
              Target Strength (MPa)
            </Label>
            <Input
              id="target_strength"
          ...
          <div className="border-t border-border pt-4">
            <h3 className="font-heading text-sm font-bold mb-4 uppercase tracking-[0.2em]">
              Material Costs (USD/kg)
            </h3>
            ...
            <div className="border border-border p-4">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={mixChartData} layout="vertical">
                  ...
                  <Tooltip contentStyle={{ border: '1px solid #E4E4E7', borderRadius: '2px', fontFamily: 'JetBrains Mono' }} />
